import { View, Text, ToastAndroid, Clipboard, Platform } from 'react-native';
...
const StreamModal = ({
  ...
  return (
    <Modal animationType={Platform.OS === 'android' ? 'none' : 'fade'} visible={downloadModal} transparent={true}>
