...
const TVPlayerScreen: React.FC<TVPlayerScreenProps> = ({ route }) => {
  ...
  useEffect(() => {
    ...
    // Use a safe check and call the imperative method ONLY if not large screen
    if (!isLargeScreen && OrientationLocker && OrientationLocker.lockToLandscape) {
    ...
    const unsubscribe = navigation.addListener('beforeRemove', () => {
      ...
      // Use a safe check and call the imperative method ONLY if not large screen
      if (!isLargeScreen && OrientationLocker && OrientationLocker.lockToPortrait) {
